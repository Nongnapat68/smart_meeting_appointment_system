...
-- ผู้ใช้งานที่ login เข้าระบบได้ (บุคลากรของคณะเทคโนโลยีสารสนเทศและการสื่อสาร เช่น อาจารย์/เจ้าหน้าที่)
CREATE TABLE "User" (
...
-- ผู้ติดต่อที่อาจถูกเชิญเข้าร่วมประชุม — คนละ entity กับ User: อาจเป็นบุคลากรภายในของคณะ
