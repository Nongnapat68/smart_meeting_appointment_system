...
**หมายเหตุสำคัญ**: Person กับ User เป็นคนละ entity — User คือคนที่ login เข้าระบบได้ (บุคลากรของสถาบัน เช่น อาจารย์/เจ้าหน้าที่), Person คือ "ผู้ติดต่อ" ที่อาจเป็น internal (ผูกกับ User) หรือ external (ไม่มี login, ผูกด้วยอีเมลอย่างเดียว) ตามที่เห็นในหน้า `people` ที่แยกคอลัมน์ "ผู้ใช้งานในระบบ" vs "บุคคลภายนอก"
